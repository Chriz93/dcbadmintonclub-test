...
writeFileSync(join(ROOT, "legacy/tests/coverage-inventory.json"), JSON.stringify({ generated: new Date().toISOString(), summary: byKind, items: all }, null, 1));
...
writeFileSync(join(ROOT, "docs/29-coverage-matrix.md"), md);
