...
-- Contents: L01 auth+rules, L03 scores+season, L04 backfill, L05 rollover, L06 statistics, L07 reminders+spares, L08 payments+push, L09 invitations, L10 payment declaration + voting lock, L11 vote log (Sunday 10 PM deadline), L12 job grants, L13 undo, L14 instant reminders (needs the Vault secret github_dispatch_token).
