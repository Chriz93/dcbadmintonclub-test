...
writeFileSync(file, JSON.stringify({ exported_at: "2026-09-11T11:30:00Z", tables: {
  ...
  app_state: [{ key: "current_session", value: "{}", created_at: "2026-09-11T00:00:00Z", updated_at: "2026-09-11T00:00:00Z", version: 3 }],
...
test("each table is restored on its own key", () => {
  ...
  assert.match(run("app_state"), /on conflict\(key\) do update/);
