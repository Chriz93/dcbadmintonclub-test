...
The subsequently supplied invoice PDF resolves compute attribution: each of production and test accrued 744 Micro compute hours, each billed $10.00 ($0.01344/hour, rounded). Gross compute $20, less $10 credit, net $10. Thus the second paid project explains the extra compute on this invoice. Fixed Pro $25 + net compute $10 + Ontario tax $4.55 = $39.55. Both egress and realtime remain within discounts. A verified switch to local/free test compute could reduce recurring cost to $28.25 including the same tax, a $11.30 reduction, assuming unchanged production plan and credit eligibility. No project altered.

The TEST dashboard currently labels compute as nano; the supplied historical invoice billed Micro compute for both projects. Do not assume the historical saving estimate exactly predicts the next invoice. No project size, plan, add-on or subscription was changed.
